  ...
  return (
    <>
      <div className="shifts">
        <div style={{ border: '10px', borderBlockColor: 'red', direction: 'rtl', margin: '40px' }}>
          <p>
            <ul>
               <li>לא ניתן לבחור יותר מיום חופש אחד.</li>
               <li>וכן ישנה בחירה של שתי משמרות ביום, שבהן ניתן לא להגיע.</li>
              </ul>
